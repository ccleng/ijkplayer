...
IJK_FFMPEG_UPSTREAM=https://github.com/ccleng/FFmpeg-ijk.git
IJK_FFMPEG_FORK=https://github.com/ccleng/FFmpeg-ijk.git
IJK_FFMPEG_COMMIT=ff4.0--ijk0.8.8--20210426--001_002
